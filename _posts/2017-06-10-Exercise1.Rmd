...
# results = c("all", "hide")
knitr::opts_chunk$set(echo = TRUE, results = 'hide', message = FALSE, warning = FALSE, fig.keep = 'none', cache = FALSE)
...
Conceptually, functions are just another object type that saves the instructions how to transform the input. Think of functions as little helpers: You give them input, either in the right order
or by explicitely telling them which is which. They remember what to do with that input and can also call on other functions to help. When they are done they will give you back some output.
```{r}
