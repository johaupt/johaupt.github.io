...
- $\tau = 2 + 0.5*X_2 + 0.5*X_2^2 - 0.5*X_1^2 - 3\cdot\mathbf{I}(X_1>0)$
...
![Density plot of treatment effect](/assets/img/output_14_0.png)
...
![Hexbin plots of relation between covariates and effect](/assets/img/output_15_1.png)
...
### Making predictions on out-of-sample data and model evaluation
...
![XBCF prediction vs true effect](/assets/img/output_31_0.png)
...
![X1 vs effect and effect estimate](/assets/img/output_34_1.png)
...
![X2 vs effect and effect estimate](/assets/img/output_35_1.png)
...
![two-model estimate vs true effect](/assets/img/output_46_0.png)
...
![double-robust estimate vs true effect](/assets/img/output_56_0.png)
